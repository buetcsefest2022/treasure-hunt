...
def register(request):
    ...
    if request.method == 'POST':
        ...
        batch_section = request.POST.get('batch_section')
        ...
        if validate_user(request, username, None):
            ...
            user = User.objects.create_user(username, None, password, first_name=batch_section)
            user.save()

            user.teamprofile.start_code = gen_key()
            user.teamprofile.password = password
            user.save()
